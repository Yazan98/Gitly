...
public class GetFollowersFirstPageQuery: GraphQLQuery {
  public static let operationName: String = "GetFollowersFirstPageQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetFollowersFirstPageQuery($id: String!) { user(login: $id) { __typename followers(first: 40) { __typename pageInfo { __typename endCursor hasNextPage } edges { __typename node { __typename login name bio avatarUrl } } } } }"#
    ))
  ...
  public struct Data: GithubGraphQlApi.SelectionSet {
    ...
    public struct User: GithubGraphQlApi.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        ...
        .field("followers", Followers.self, arguments: ["first": 40]),
      ] }
