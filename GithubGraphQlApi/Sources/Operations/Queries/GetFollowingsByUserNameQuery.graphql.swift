...
public class GetFollowingsByUserNameQuery: GraphQLQuery {
  public static let operationName: String = "GetFollowingsByUserNameQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetFollowingsByUserNameQuery($id: String!, $pageId: String!) { user(login: $id) { __typename following(first: 40, after: $pageId) { __typename pageInfo { __typename endCursor hasNextPage } edges { __typename node { __typename login name bio avatarUrl } } } } }"#
    ))
